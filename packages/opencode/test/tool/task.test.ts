...
test("accepts valid model_tier values", async () => {
  ...
  await Instance.provide({
    ...
    fn: async () => {
      ...
      const result = schema.safeParse({ description: "Test", prompt: "Test prompt", subagent_type: "build", model_tier: "quick" })
...
test("rejects invalid model_tier values", async () => {
  ...
  await Instance.provide({
    ...
    fn: async () => {
      ...
      const result = schema.safeParse({ description: "Test", prompt: "Test prompt", subagent_type: "build", model_tier: "invalid" })
